...
protected: // new virtual functions, possibly redefined by subclasses
  ...
  virtual void closeStreamSource(FramedSource* inputSource);
	virtual void* getLastStreamToken() {return fLastStreamToken;}
	virtual HashTable* getDestinationsHashTable() {return fDestinationsHashTable;}
...
private:
  ...
  friend class StreamState;
	...
	static portNumBits fLastInitialPortNum;
};
