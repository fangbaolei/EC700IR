...
#ifndef _BYTE_STREAM_SOCKET_SOURCE_HH
#define _BYTE_STREAM_SOCKET_SOURCE_HH
...
class ByteStreamSocketSource: public FramedSource {
public:
  static ByteStreamSocketSource* createNew(UsageEnvironment& env,
					 char const* fileName,
...
protected:
  ByteStreamSocketSource(UsageEnvironment& env,
		       int sockfd,
		       unsigned preferredFrameSize,
		       unsigned playTimePerFrame);
	// called only by createNew()

  virtual ~ByteStreamSocketSource();

  static void socketReadableHandler(ByteStreamSocketSource* source, int mask);
  void doReadFromSocket();
  unsigned int dateTimeGetTick();
