...
# ARM与DSP程序、FPGA文件
ARM_DSP_FILES="App/LprApp  App/fpga.xsvf"
# 应用程序文件
APP_FILES=" App/deamon App/command App/log App/fpga_test App/UpgradeApp"
XML_FILES="App/deamon.xml App/LprApp.xml App/command.sh"
LOADER="App/loader"
