...
sudo ./mkrootfs_jupiter_back.sh 
./mk_jupiter_backsys.sh
cp ./jupiter_bak.img ${MAIN_PATH}/$IMAGE_NAME.img
...
cp  -vf ../venus/0_uboot_kernel/uImage.venus ${PRODUCT_EXPORT_PATH}/${HARDWARE_NAME_LITE}_uImage_r${ROOTFS_VERSION}.jupiter
cp  -vf ./jupiter_rootfs_back.img ${PRODUCT_EXPORT_PATH}/${HARDWARE_NAME_LITE}_rootfs_back_r${ROOTFS_VERSION}.img  
