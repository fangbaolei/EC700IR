#ifndef __SW_CAMERA_CONTROL_2A_MSG_H__
#define __SW_CAMERA_CONTROL_2A_MSG_H__
#include "SWObject.h"
#include "SWMessage.h"
#include "SWCameraControlParameter.h"


class CSWCameraControl2AMSG : public CSWMessage, public CSWObject
{
		CLASSINFO(CSWCameraControl2AMSG, CSWObject)
public:
    CSWCameraControl2AMSG();
    virtual ~CSWCameraControl2AMSG();
...
protected:
	...
	*/
	...
	BOOL OnIncreaseBrightness(VOID);
     ...
     //消息映射宏定义
    SW_BEGIN_MESSAGE_MAP(CSWCameraControl2AMSG, CSWMessage)
        //初始化模块
        ...
        SW_MESSAGE_HANDLER(MSG_SET_WDR_LEVEL, OnSetWDRLevel)
	 	...
	 	SW_MESSAGE_HANDLER(MSG_SET_TNF_STATE, OnSetTNFState)
		SW_MESSAGE_HANDLER(MSG_GET_TNF_STATE, OnGetTNFState)
		SW_MESSAGE_HANDLER(MSG_SET_SNF_STATE, OnSetSNFState)
		SW_MESSAGE_HANDLER(MSG_GET_SNF_STATE, OnGetSNFState)
