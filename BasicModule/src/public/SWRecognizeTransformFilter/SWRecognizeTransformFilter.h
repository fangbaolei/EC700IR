...
class CSWRecognizeTransformFilter : public CSWBaseFilter, CSWMessage
{
	CLASSINFO(CSWRecognizeTransformFilter, CSWBaseFilter)
public:
	CSWRecognizeTransformFilter();
	virtual ~CSWRecognizeTransformFilter();
...
protected:
	...
	SW_END_DISP_MAP()
	//消息映射宏
	SW_BEGIN_MESSAGE_MAP(CSWRecognizeTransformFilter, CSWMessage)
...
REGISTER_CLASS(CSWRecognizeTransformFilter)
#endif
