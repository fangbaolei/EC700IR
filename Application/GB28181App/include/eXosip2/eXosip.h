 ...
 */
  typedef enum eXosip_event_type
  {
    ...
    EXOSIP_REGISTRATION_NEW,           /**< announce new registration.     		0 */
    EXOSIP_REGISTRATION_SUCCESS,       /**< user is successfully registred. 	1 */
    EXOSIP_REGISTRATION_FAILURE,       /**< user is not registred.           	2 */
    EXOSIP_REGISTRATION_REFRESHED,     /**< registration has been refreshed. 	3 */
    EXOSIP_REGISTRATION_TERMINATED,    /**< UA is not registred any more.    	4 */

    /* INVITE related events within calls */
    EXOSIP_CALL_INVITE,            /**< announce a new call                  	5 */
    EXOSIP_CALL_REINVITE,          /**< announce a new INVITE within call    	6 */

    EXOSIP_CALL_NOANSWER,          /**< announce no answer within the timeout 	7 */
    EXOSIP_CALL_PROCEEDING,        /**< announce processing by a remote app   	8 */
    EXOSIP_CALL_RINGING,           /**< announce ringback                       9 */
    EXOSIP_CALL_ANSWERED,          /**< announce start of call                 10 */
    EXOSIP_CALL_REDIRECTED,        /**< announce a redirection                 11 */
    EXOSIP_CALL_REQUESTFAILURE,    /**< announce a request failure             12 */
    EXOSIP_CALL_SERVERFAILURE,     /**< announce a server failure              13 */
    EXOSIP_CALL_GLOBALFAILURE,     /**< announce a global failure              14 */
    EXOSIP_CALL_ACK,               /**< ACK received for 200ok to INVITE       15 */

    EXOSIP_CALL_CANCELLED,         /**< announce that call has been cancelled  16 */
    EXOSIP_CALL_TIMEOUT,           /**< announce that call has failed          17 */

    /* request related events within calls (except INVITE) */
    EXOSIP_CALL_MESSAGE_NEW,              /**< announce new incoming request.  18 */
    EXOSIP_CALL_MESSAGE_PROCEEDING,       /**< announce a 1xx for request.     19 */
    EXOSIP_CALL_MESSAGE_ANSWERED,         /**< announce a 200ok  			   20 */
    EXOSIP_CALL_MESSAGE_REDIRECTED,       /**< announce a failure. 			   21 */
    EXOSIP_CALL_MESSAGE_REQUESTFAILURE,   /**< announce a failure. 			   22 */
    EXOSIP_CALL_MESSAGE_SERVERFAILURE,    /**< announce a failure. 			   23 */
    EXOSIP_CALL_MESSAGE_GLOBALFAILURE,    /**< announce a failure. 			   24 */

    EXOSIP_CALL_CLOSED,            /**< a BYE was received for this call       25 */

    /* for both UAS & UAC events */
    EXOSIP_CALL_RELEASED,             /**< call context is cleared.        	   26 */

    /* response received for request outside calls */
    EXOSIP_MESSAGE_NEW,              /**< announce new incoming request.	   27 */
    EXOSIP_MESSAGE_PROCEEDING,       /**< announce a 1xx for request.		   28 */
    EXOSIP_MESSAGE_ANSWERED,         /**< announce a 200ok  				   29 */
    EXOSIP_MESSAGE_REDIRECTED,       /**< announce a failure.				   30 */
    EXOSIP_MESSAGE_REQUESTFAILURE,   /**< announce a failure. 				   31 */
    EXOSIP_MESSAGE_SERVERFAILURE,    /**< announce a failure. 				   32 */
    EXOSIP_MESSAGE_GLOBALFAILURE,    /**< announce a failure. 				   33 */

    /* Presence and Instant Messaging */
    EXOSIP_SUBSCRIPTION_UPDATE,         /**< announce incoming SUBSCRIBE.      34 */
    EXOSIP_SUBSCRIPTION_CLOSED,         /**< announce end of subscription.     35 */

    EXOSIP_SUBSCRIPTION_NOANSWER,          /**< announce no answer             36 */
    EXOSIP_SUBSCRIPTION_PROCEEDING,        /**< announce a 1xx                 37 */
    EXOSIP_SUBSCRIPTION_ANSWERED,          /**< announce a 200ok               38 */
    EXOSIP_SUBSCRIPTION_REDIRECTED,        /**< announce a redirection         39 */
    EXOSIP_SUBSCRIPTION_REQUESTFAILURE,    /**< announce a request failure     40 */
    EXOSIP_SUBSCRIPTION_SERVERFAILURE,     /**< announce a server failure      41 */
    EXOSIP_SUBSCRIPTION_GLOBALFAILURE,     /**< announce a global failure      42 */
    EXOSIP_SUBSCRIPTION_NOTIFY,            /**< announce new NOTIFY request    43 */

    EXOSIP_SUBSCRIPTION_RELEASED,          /**< call context is cleared.       44 */

    EXOSIP_IN_SUBSCRIPTION_NEW,            /**< announce new incoming SUBSCRIBE.45*/
    EXOSIP_IN_SUBSCRIPTION_RELEASED,       /**< announce end of subscription.  46 */

    EXOSIP_NOTIFICATION_NOANSWER,          /**< announce no answer             47 */
    EXOSIP_NOTIFICATION_PROCEEDING,        /**< announce a 1xx                 48 */
    EXOSIP_NOTIFICATION_ANSWERED,          /**< announce a 200ok               49 */
    EXOSIP_NOTIFICATION_REDIRECTED,        /**< announce a redirection         50 */
    EXOSIP_NOTIFICATION_REQUESTFAILURE,    /**< announce a request failure     51 */
    EXOSIP_NOTIFICATION_SERVERFAILURE,     /**< announce a server failure      52 */
    EXOSIP_NOTIFICATION_GLOBALFAILURE,     /**< announce a global failure      53 */

    EXOSIP_EVENT_COUNT                  /**< MAX number of events              54 */
  } eXosip_event_type_t;
