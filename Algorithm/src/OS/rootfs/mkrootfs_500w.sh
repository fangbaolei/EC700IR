...
# 文件名称：mkrootfs_500w.sh
# 功能：500w一体机根文件系统镜像制作脚本
# 使用：
# 用root权限运行，ubuntu可用sudo ./mkrootfs_500w.sh

# 默认制作正式版本镜像文件
# 如制作调试版本(即网络启动)，使用命令：
# ./mkrootfs_500w.sh debug
...
# 驱动文件
SLW_DEV_FILE="Script/slw-dev_500w.ko"
...
ADD_KO_SLAVE="Script/loadko_pci_slave_500w.sh"
...
cp -fp $SLW_DEV_FILE ../$TMP/lib/modules/slw-dev.ko
