...
#elif ( RUN_PLATFORM == PLATFORM_DSP_BIOS || RUN_PLATFORM == PLATFORM_DSP_NOBIOS )
#ifndef CHIP_8127
	typedef unsigned long QWORD64, *PQWORD64, *LPQWORD64;
	typedef long SQWORD64, *PSQWORD64, *LPSQWORD64;
#else
	typedef unsigned __int40_t QWORD64, *PQWORD64, *LPQWORD64;
	typedef __int40_t SQWORD64, *PSQWORD64, *LPSQWORD64;
#endif
	typedef SDWORD32 HRESULT;
#elif ( RUN_PLATFORM == PLATFORM_LINUX )
	typedef uint64_t	QWORD64, *PQWORD64, *LPQWORD64;
	typedef int64_t SQWORD64, *PSQWORD64, *LPSQWORD64;
	typedef int HRESULT;
	typedef uint64_t	DWORD64, *PDWORD64, *LPDWORD64;
