...
#define JPEG_MAXIMUM_COMPONENTS 3 //by liaoy: 只处理3分量图
...
#define JPEG_FIXSHIFT 5 //因修改了IDCT,此处固定为5
...
#include <stdlib.h>
#define JPEG_Assert(TEST) \
	if (!(TEST)) { printf( __FILE__ "(%d): " #TEST "\n", __LINE__); return 0; }
#else
#define JPEG_Assert(TEST)
#endif /* JPEG_DEBUG */
#endif /* JPEG_Assert */
