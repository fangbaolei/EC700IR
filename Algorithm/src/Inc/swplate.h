...
const int g_cnChars = 118;				// 字符集合长度
...
inline bool IsMilitaryAlpha(BYTE8 nID)  //change liangjf
{
	// 军牌字母
	if ((nID == 12) || (nID == 13) || (nID == 15)|| (nID == 17) ||
		(nID == 18) || (nID == 20) || (nID == 21) ||(nID == 22) || 
		(nID == 24) || (nID == 29) || (nID == 32) || (nID == 36))
	{
		return true;
	}
	return false;
