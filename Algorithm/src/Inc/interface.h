...
static __inline LPCSTR GetDebugDeviceName( int iDeviceID )
{
	return g_rgkszDebugDeviceName[iDeviceID];
}

static __inline void EnableDebugDevice( int iDeviceID, int fEnable )
{
	g_rgfDebugDeviceEnabled[ iDeviceID ] = fEnable;
}

static __inline int IsDebugDeviceEnabled( int iDeviceID )
{
	return g_rgfDebugDeviceEnabled[ iDeviceID ];
}

static __inline LPCSTR GetDebugLogPath(int iDeviceID)
{
	return g_rgkszDebugLogPath[iDeviceID];
}

static __inline void SetSaveLogFile(BOOL fSave)
{
