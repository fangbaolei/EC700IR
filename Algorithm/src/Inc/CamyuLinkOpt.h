...
#define  CY_SOFT_TRIGGER	0xf0// 软件触发命令 1-主通道闪光 0-副通道闪光
...
#define  CY_EXP_OUT_EN     0x127 // 曝光同步输出( d0--闪光灯 d1--频闪 )
...
#define LIB_HB_ACK 0x55AA55AA /* 通信心跳帧应答码 */
