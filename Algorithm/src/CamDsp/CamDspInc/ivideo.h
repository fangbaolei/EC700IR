 ...
 */
/**
 *  @addtogroup   ti_xdais_dm_IVIDEO    xDM 1.20 Video Interface
 *
 *  This is the xDM 1.20 video interface shared between the various codecs.
 */
...
/*
 *  @(#) ti.xdais.dm; 1, 0, 4,160; 5-8-2008 09:05:49; /db/wtree/library/trees/dais-j06x/src/
 */
