...
//DEL CVcFootnote CMSChart::GetFootnote()
//DEL {
//DEL 	LPDISPATCH pDispatch;
//DEL 	InvokeHelper(0x1b, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
//DEL 	return CVcFootnote(pDispatch);
//DEL }
