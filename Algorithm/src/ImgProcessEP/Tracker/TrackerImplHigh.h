...
protected:
	...
	static const int s_knMaxPlateCandidate = 2;
	static const int s_knMaxObjCandidate = 2;
	static const int s_knMaxVideoChannel = 2;
		...
		)
	{
		...
		m_cDjAppTracker.UpdatemRedLightRect(m_rgRedLightRect, m_nRedLightCount);
		return S_OK;
	}
