...
*  EPolice控制类
*/
class CEPolice : public CHvThreadBase, public IDataCtrl
{
public:
    CEPolice();
    ~CEPolice();
    ...
    void MountEventChecker(CEventChecker_EP *pEventChecker)
    {
        m_pEventChecker = pEventChecker;
    }
    ...
    void SetFlashLampDiff(int nDiff)
    {
        m_nFlashLampDiff = nDiff;
    }
protected:
