...
)
{
    ...
    */
    ...
    HvParamReadIntWithWrite(
        pcParamStore, "\\HvDsp\\VideoProc\\PanoramicCamera", "Enable",
        &cResultSenderParam.iEnablePanoramicCamera, cResultSenderParam.iEnablePanoramicCamera,
        0, 1,
        "全景相机使能开关， 0为不使能，1为使能", "",
        PROJECT_LEVEL);
    HvParamReadStringWithWrite(
        pcParamStore, "\\HvDsp\\VideoProc\\PanoramicCamera", "PanoramicCameraIP",
        cResultSenderParam.szPanoramicCameraIP,
        sizeof(cResultSenderParam.szPanoramicCameraIP),
        "全景相机IP地址", "",
        PROJECT_LEVEL);
#endif
...
)
{
    ...
    HvParamReadIntWithWrite(
        pcParamStore,
        "\\OuterCtrl", "EnableSwitchFlashLight",
        &cSignalMatchParam.nSwitchFlashLightCount,
        cSignalMatchParam.nSwitchFlashLightCount, 0, 100000,
        "线圈触发和视频触发切换的阈值", "当识别结果个数减去抓拍图个数大于此值时，自动切换到视频触发,0为不切换",
        CUSTOM_LEVEL
    );
    HvParamReadIntWithWrite(
        pcParamStore,
...
)
{
    HvParamReadIntWithWrite(
        pcParamStore,
        "\\Tracker\\Recognition", "EnableRecogCarColor",
    ...
    HvParamReadIntWithWrite(
        pcParamStore,
        "\\Tracker\\Recognition", "RecogFace",
        &cTrackerCfgParam.fEnableDetFace, cTrackerCfgParam.fEnableDetFace,
        0, 1,
        "人脸检测开关", "", CUSTOM_LEVEL
    );
    HvParamReadIntWithWrite(
        pcParamStore,
        "\\Tracker\\Recognition", "FaceMin",
        &cTrackerCfgParam.nMinFaceScale, cTrackerCfgParam.nMinFaceScale,
        0, 20,
        "最小人脸宽度(按图片宽度百分比计算)", "", CUSTOM_LEVEL
    );
    HvParamReadIntWithWrite(
        pcParamStore,
        "\\Tracker\\Recognition", "FaceMax",
        &cTrackerCfgParam.nMaxFaceScale, cTrackerCfgParam.nMaxFaceScale,
        0, 20,
        "最大人脸宽度(按图片宽度百分比计算)", "", CUSTOM_LEVEL
    );
    if (cTrackerCfgParam.nMinFaceScale > cTrackerCfgParam.nMaxFaceScale)
    {
        cTrackerCfgParam.nMinFaceScale = 2;
        cTrackerCfgParam.nMaxFaceScale = 20;
        HvParamWriteInt(pcParamStore,
                        "\\Tracker\\Recognition", "FaceMin",
                        cTrackerCfgParam.nMinFaceScale, cTrackerCfgParam.nMinFaceScale,
                        0, 20,
                        "最小人脸宽度(按图片宽度百分比计算)", "", CUSTOM_LEVEL
...
//========End ProcessPlate==================
    ...
    cTrackerCfgParam.nCarArrivedPos = 70;
    HvParamReadIntWithWrite(
        pcParamStore,
    ...
    cTrackerCfgParam.nCarArrivedPosNoPlate = 55;
    HvParamReadIntWithWrite(
        pcParamStore,
    ...
    cTrackerCfgParam.nCarArrivedPosYellow = 55;
    HvParamReadIntWithWrite(
        pcParamStore,
