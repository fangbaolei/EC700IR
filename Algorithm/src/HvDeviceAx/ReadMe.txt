========================================================================
    ACTIVEX CONTROL DLL : HvDeviceAx Project Overview
========================================================================

ControlWizard has created this project for your HvDeviceAx ActiveX Control
...
that make up your HvDeviceAx ActiveX Control DLL.
...
HvDeviceAx.ico
    ...
    is included by the main resource file HvDeviceAx.rc.

/////////////////////////////////////////////////////////////////////////////
CHvDeviceAxCtrl control:

HvDeviceAxCtrl.h
    This file contains the declaration of the CHvDeviceAxCtrl C++ class.

HvDeviceAxCtrl.cpp
    This file contains the implementation of the CHvDeviceAxCtrl C++ class.

HvDeviceAxPropPage.h
    This file contains the declaration of the CHvDeviceAxPropPage C++ class.

HvDeviceAxPropPage.cpp
    This file contains the implementation of the CHvDeviceAxPropPage C++ class.

CHvDeviceAxCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CHvDeviceAxCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file HvDeviceAx.rc.
...
stdafx.h, stdafx.cpp
    ...
    named HvDeviceAx.pch and a precompiled types (PCT) file named stdafx.obj.
